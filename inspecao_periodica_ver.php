...
<html lang="en">
   <head>
    ...
    <title>FMT | Ver Inspeção Periódica</title>
...
<div class="conteudo">
   <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<ol class="breadcrumb" style="width: 800px">
				...
				<li><a href="./gerir_inspecoes.php">Gerir Inspeções</a></li>
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<label type="text" class="form-control" id="horap3"><?php echo $inspecoes->getIdViatura() ?></label>
						</div>					
					</form>
					...
					<form>
						<div class="form-group">
							...
							<label type="text" class="form-control" id="horap2"><?php echo $inspecoes->getEstado() ?></label>
						</div>
					</form>	
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<label type="text" class="form-control" id="horap" ><?php echo $inspecoes->getDataLimite() ?></label>
						</div>
					</form>	
		  		...
		  		<a href="./gerir_inspecoes.php" class="btn btn-danger btn-xl pull-right" > Voltar </a>
	</div>
	</div>
    </div>
