...
<html lang="en">
  <head>
    ...
    <title>FMT | Manutenção Interna de Viaturas</title>
		  ...
		  <h2 class="sub-header">Manutenção Interna</h2>
			<div class="centered">
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							<label class="horapar1">Data:</label>
							<input type="date" class="form-control" id="horap5" >
						</div>
					</form>	
                                    ...
                                    <td>
                                        <form>
                                            <div class="form-group">
												...
												<input type = "text" class="form-control" id="kc" placeholder="Quantidade"></input>
                                            </div>
                                        </form>
                                    </td>
									 <td>
