...
<head>
    ...
    <title>FMT | Alterar Transporte Doentes</title>
            ...
            <div class="conteudo">
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <ol class="breadcrumb" style="width: 800px">
                        ...
                        <li>Alterar Transporte Doentes</li>
                    </ol>
                    ...
                    <div class="centered">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="#" class="btn btn-primary btn-xl">Adicionar Utente</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="nome" value="<?php echo $transportes->getDataTransporte() ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-2">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="horap" value="<?php echo $transportes->getHoraDePartida() ?>" maxlength="5">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-2">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="horac" value="<?php echo $transportes->getHoraDeChegada() ?>" maxlength="5">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="origem" value="<?php echo $transportes->getOrigem() ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="destino" value="<?php echo $transportes->getDestino() ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <form>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" cols="30" value="<?php echo $transportes->getObservacoes() ?>"></textarea>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ks" value="<?php echo $transportes->getQuilometrospartida() ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kc" value="<?php echo $transportes->getQuilometroschegada() ?>">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="pull-right">
                            ...
                            <br />
                            <br />
                            <a href="gerir_transporte_doentes.html" class="btn btn-danger btn-xl"> Voltar </a>
                            <a class="btn btn-primary btn-xl" href="gerir_transporte_doentes.html"> Aplicar </a>
                            <br/>
                        </div>
