                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <div class="centered col-sm-6 col-md-9">
                        ...
                        <div class="col-sm-6 col-md-11">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nu" placeholder="Inserir Nome do Utente">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nsn" placeholder="Inserir Nº SNS">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="numtelefone" placeholder="Nº de Telefone">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-11">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rua" placeholder="Inserir a Rua">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="pull-right">
                            ...
                            <a class="btn btn-primary btn-xl" href="gerir_utente.html"> Adicionar </a>
                            <br/>
                        </div>
                           <?php
                           if(isset($_POST["nu"]) && !empty($_POST["nu"])&& isset($_POST["nsn"]) && !empty($_POST["nsn"]) && isset($_POST["datanasc"]) && !empty($_POST["datanasc"]) && isset($_POST["numtelefone"]) && !empty($_POST["numtelefone"]) && isset($_POST["rua"]) && !empty($_POST["rua"]) && isset($_POST["nporta"]) && !empty($_POST["nporta"])&& isset($_POST["localidade"]) && !empty($_POST["localidade"])&& isset($_POST["cp"]) && !empty($_POST["cp"])){
                                $utentes = $gere_utentes->adicionarUtente();   
                            }
