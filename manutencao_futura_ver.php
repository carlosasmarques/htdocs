...
<head>
    ...
    <title>FMT | Ver Manutenção Futura de Viatura</title>
...
<div class="conteudo">
		...
		<ol class="breadcrumb" style="width: 800px">
				...
				<li >Ver Manutenção Futura de Viatura </li>
			</ol>
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<label class="form-control" id="matricula">45-AI-10</label>
						</div>					
					</form>
					...
					<form>
						<div class="form-group">
							...
							<label class="form-control" id="descmanut"><?php echo $manutencaoexter->getDescricaoManutencao() ?></label>
						</div>
					</form>	
					...
					<form>
						<div class="form-group">
							...
							<label class="form-control" value="estadomanut"><?php echo $manutencaoexter->getEstado() ?></label>
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<label type="date" class="form-control" id="horap3" ><?php echo $manutencaoexter->getData() ?></label>
						</div>
					</form>	
					...
					<form>
						<div class="form-group">
							...
							<label type="text" class="form-control" id="horap2" placeholder="130000"><?php echo $manutencaoexter->getQuilometragem() ?></label>
						</div>
					</form>	
			...
			<a class="btn btn-primary btn-xl pull-right"  href="./manutencao.html"> Guardar </a><br/>
	</div>
	</div>
    </div>
