<?php
	...
	$mens_rec = new GereMensRec();
	$mensrec = new MensEnv(0, "", "", "", "", "", "", "");
            ...
            <div class="conteudo">
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <ol class="breadcrumb" style="width: 800px">
                        ...
                        <li><a href="./mensagens_recebidas.html">Mensagens Recebidas/Enviadas</a>
                        </li>
                        <li class="active">Ver Mensagem</li>
                    </ol>
                                ...
                                <div class="col-sm-offset-3 col-sm-6" style="margin-left: 15%">
                                    ...
                                    <form name="sentMessage" class="well" id="enviarmensagem" novalidate>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="form-control" id="nomeremetente">Nome do Remetente</label>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="form-control" id="nomedestinario">Nome do Destinatário XPTO</label>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="form-control" id="assunto">Assunto xxxxxx</label>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="form-control" id="mensagem" style="resize:none; height:214px;">Isto é a Mensagem do Manel</label>
                                            </div>
                                        </div>
                                        <br>
                                        <div id="success"></div>
                                        <!-- For success/fail messages -->
                                        <button type="submit" class="btn btn-primary btn-xl">Responder</button>
                                        <a href="mensagens_recebidas.html" class="btn btn-danger btn-xl">Voltar</a>
                                        <br />
                                    </form>
                                </div>
                            </div>
