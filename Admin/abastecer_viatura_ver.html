...
<html lang="en">
  <head>
    ...
    <title>FMT | Ver Abastecimento de Viatura</title>
...
<div class="conteudo">
		...
		<ol class="breadcrumb" style="width: 800px">
				...
				<li><a href="./abastecer_viatura.html">Gerir Abastecimentos</a></li>
				...
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="quantidadecombustivel" placeholder="25">
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="data">Local:</label>
							<input type="text" class="form-control" id="nome" placeholder="Galp Coja">
						</div>				
					</form>	
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<input type="date" class="form-control" id="datadeabastecimento">
						</div>				
					</form>	
					...
					<form>
						<div class="form-group">
							<label class="kc">Quilómetros Atuais:</label>
							<input type="text" class="form-control" id="quilomentrosatuais" placeholder="100000">
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="horapar">Consumo Médio:</label>
							<label class="form-control" id="consumomedio"> 12 </label>
						</div>
					</form>	
		  		...
		  		<a href="./abastecer_viatura.html" class="btn btn-danger btn-xl pull-right" > Voltar </a>
			<a class="btn btn-primary btn-xl pull-right"  href="./abastecer_viatura.html"> Guardar </a><br/>
	</div>
	</div>
    </div>
