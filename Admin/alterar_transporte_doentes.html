                        ...
                        <div class="col-sm-6 col-md-6">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="origem" placeholder="Altere os dados">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="destino" placeholder="Altere os dados">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ks" placeholder="Altere os dados">
                                </div>
                            </form>
                        </div>
