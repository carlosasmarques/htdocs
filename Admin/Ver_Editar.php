            ...
            <div class="conteudo">
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <ol class="breadcrumb" style="width: 800px">
                        ...
                        <li><a href="Gestao_stock.html">Gestão de Stocks</a>
                        </li>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nf1" placeholder="20100">
                            </div>
                            <div class="form-group">
                                <label class="PreçodoArtigo">Preço do Artigo:</label>
                                <br>
                                <input type="text" class="form-control" id="nu1" placeholder="120">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nu2" placeholder="5">
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nf2" placeholder="Capacete">
                            </div>

                            <div class="form-group">
                                <label class="qtminimapermitida">Quantidade Mínima Permitida:</label>
                                <input type="text" class="form-control" id="nu3" placeholder="2">
                            </div>

                            <div class="form-group">
                                <label class="TipodeArtigo">Tipo de Artigo:</label>
                                <select class="form-control">
                                    <option>Equipamento de Combate a Incêndios</option>
                            ...
                            <div class="pull-right">
                                ...
                                <a class="btn btn-primary btn-xl pull-right" href="./Gestao_stock.html"> Guardar Alterações </a>
                                <br/>
                            </div>
                        </form>
