...
<html lang="en">
  <head>
    ...
    <title>FMT | Inspeção Periódica de Viatura</title>
...
<div class="conteudo">
		...
		<ol class="breadcrumb" style="width: 800px">
				...
				<li >Nova Inspeção Periódica </li>
			</ol>
		  
		    <h2 class="sub-header">Nova Inspeção Periódica</h2>
			<div class="centered">
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<select class="form-control">
								<option value="desc">Indique o estado da inspeção</option>
			...
			<a class="btn btn-primary btn-xl pull-right"  href="./gerir_inspecoes.php"> Guardar </a><br/>
	</div>
	</div>
    </div>
