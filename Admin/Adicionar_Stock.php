                        ...
                        <div>
                            ...
                            <form>
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <a class="btn btn-default" href="./Gestao_stock.html">Confirmar</a>

                                    </div>
                                    <div class="btn-group">
                                        <a class="btn btn-default" href="./Gestao_stock.html">Voltar</a>
                        ...
                        <form>
                            ...
                            <div id="openTipo" class="modalDialog">
                                <div>
                                    ...
                                    <a href="./Adicionar_Stock.html" class="btn btn-danger btn-xl pull-right"> Voltar </a>
                                    <a class="btn btn-primary btn-xl pull-right" href="./Adicionar_Stock.html"> Adicionar Novo </a>
                                    <br/>
