...
<head>
    ...
    <title>FMT | Registo de Consumos</title>
            ...
            <div class="conteudo">
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <ol class="breadcrumb" style="width: 800px">
                        ...
                        <li class="active">Registo de Consumos</li>
                    </ol>


                    <div class="centered col-sm-6 col-md-9">

                        <h2 class="sub-header">Registo de Consumos</h2>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <select class="form-control">
                                        <option value="nome do artigo consumido">Nome do Artigo Consumido:</option>
                                        <option>Máscara de proteção individual hs-20</option>
                                        <option>Pás para o desfibrilhador</option>
                                        <option>Betadine 250ml</option>
                                    </select>
                        ...
                        <div class="col-sm-6 col-md-7">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="quacon" placeholder="Inserir dados">
                                </div>
                            </form>
                        ...
                        <div class="pull-right">
                            <br />
                            <a class="btn btn-primary btn-xl" href="registo_consumos.html"> Adicionar </a>
                            <br/>
                        </div>
