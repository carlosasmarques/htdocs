				...
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<textarea class="form-control" id="kc2" placeholder="Altere os dados"></textarea>
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="horapar">Preço da reparação:</label>
							<input type="text" class="form-control" id="horap3" placeholder="Indique o preço" maxlength="5">
						</div>
					</form>	
				...
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="horap2" placeholder="Indique a oficina" maxlength="5">
						</div>
					</form>	
