...
<div class="conteudo">
		...
		<ol class="breadcrumb" style="width: 800px">
          ...
          <div class="table-responsive">
			...
			<a class="btn btn-primary btn-xl pull-right"  href="./adicionar_abastecimento.php"> Abastecer Viatura </a>
                ...
                <div class="tab-pane fade in active" id="home">
                    <div class="list-group">
						<span class="list-group-item">
							...
							<span class="Quantidade" style="min-width: 120px; display: inline-block;" >45-AI-10</span>
							<span class="Descrição" style="min-width: 140px; display: inline-block;" >25</span> 
                            <span class="Descrição" style="min-width: 120px; display: inline-block;" >100000</span> 
						    <span class="Descrição" style="min-width: 150px; display: inline-block;" >8</span> 
							<a href="abastecer_viatura_ver.php" class="btn btn-xs" >Ver/Editar</a>
							</div>
							
							<div  class="list-group-item">
                            <span class="Codigo" style="min-width: 60px; display: inline-block;">002</span> 
							<span class="Quantidade" style="min-width: 120px; display: inline-block;" >13-AH-35</span>
							<span class="Descrição" style="min-width: 140px; display: inline-block;" >50</span> 
							<span class="Descrição" style="min-width: 120px; display: inline-block;" >70000</span> 
							<span class="Descrição" style="min-width: 150px; display: inline-block;" >6</span> 
							<a href="abastecer_viatura_ver.php" class="btn btn-xs" >Ver/Editar</a>
							</div>
							
							<div  class="list-group-item">
                            <span class="Codigo" style="min-width: 60px; display: inline-block;">003</span> 
							<span class="Quantidade" style="min-width: 120px; display: inline-block;" >21-38-XT</span>
							<span class="Descrição" style="min-width: 140px; display: inline-block;" >40</span> 
							<span class="Descrição" style="min-width: 120px; display: inline-block;" >80000</span> 
							<span class="Descrição" style="min-width: 150px; display: inline-block;" >9</span> 
