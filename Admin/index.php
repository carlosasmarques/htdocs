...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin">
            ...
            <input type="text" class="form-control" placeholder="Administrador" title="Introduza o seu nome de Administrador" autofocus>
            ...
            <a class="btn btn-lg btn-primary btn-block" title="Pressione para concluir a autenticação" href="inicial.html">Entrar</a>
        </form>
