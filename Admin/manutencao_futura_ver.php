				...
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<textarea class="form-control" id="kc" placeholder="Revisão completa"></textarea>
						</div>
					</form>	
					<form>
						<div class="form-group">
							...
							<select class="form-control">
								<option value="desc">Indique Estado da Manutenção</option>
				...
				<div class="col-sm-6 col-md-4">				
					<form>
						<div class="form-group">
							...
							<input type="date" class="form-control" id="horap3"  >
						</div>
					</form>	
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="horap2" placeholder="130000" >
						</div>
					</form>	
