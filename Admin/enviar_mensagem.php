                                ...
                                <div class="col-sm-offset-3 col-sm-6" style="margin-left: 15%">
                                    ...
                                    <form name="sentMessage" class="well" id="enviarmensagem" novalidate>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <label class="form-control" id="nomeremetente">Administrador</label>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <select class="form-control">
                                                    <option value="nomedodestinatario">Nome do Destinatário</option>
                                                    <option>António Costa</option>
                                                    <option>Carlos Marques</option>
                                                    <option>Tózé Lopes</option>
                                                </select>
                                                <p class="help-block"></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <textarea rows="10" cols="100" class="form-control" placeholder="Mensagem" id="message" required data-validation-required-message="Introduza a sua mensagem" data-validation-minlength-message="Insira no minimo 5 caracteres" maxlength="999" style="resize:none"></textarea>
                                            </div>
                                        </div>
                                        <br>
