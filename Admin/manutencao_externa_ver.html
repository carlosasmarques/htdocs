		...
		<ol class="breadcrumb" style="width: 800px">
			...
			<div class="centered">
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							...
							<textarea class="form-control" id="kc" placeholder="Carro não liga"></textarea>
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="kc">Descrição da reparação:</label>
							<textarea class="form-control" id="kc2" placeholder="Novo motor de arranque"></textarea>
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="horapar">Preço da reparação:</label>
							<input type="text" class="form-control" id="horap2" placeholder="130" maxlength="5">
						</div>
					</form>	
				...
				<div class="col-sm-6 col-md-4">				
					...
					<form>
						<div class="form-group">
							<label class="horapar2">Oficina:</label>
							<input type="text" class="form-control" id="horap3" placeholder="Oficina do zé" maxlength="5">
						</div>
					</form>	
					<form>
						<div class="form-group">
							<label class="horapar3">Data da reparação:</label>
							<input type="date" class="form-control" id="horap2" >
						</div>
					</form>	
