                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                                ...
                                <div class="list-group-item">
                                    ...
                                    <span style="min-width: 160px; display: inline-block;">Zeca Baleiro</span>
                                    <span style="min-width: 160px; display: inline-block;">Mecanico</span>
                                    <span style="min-width: 160px; display: inline-block;">123456789</span>
                                    <span style="min-width: 160px; display: inline-block;"><a href="alterar_utilizador.php" class="btn btn-xs" >Ver / Alterar</a><a href="ver_log_utilizador.php" class="btn btn-xs" >Ver log</a><a href="#" class="btn btn-primary btn-xs">Ativar</a></span>
                                </div>
                                <div class="list-group-item">
                                    <span style="min-width: 160px; display: inline-block;">0003</span> 
                                    <span style="min-width: 160px; display: inline-block;">Gonçalo Filipe</span>
                                    <span style="min-width: 160px; display: inline-block;">Mecanico</span>
                                    <span style="min-width: 160px; display: inline-block;">123456789</span>
                                    <span style="min-width: 160px; display: inline-block;"><a href="alterar_utilizador.php" class="btn btn-xs" >Ver / Alterar</a><a href="ver_log_utilizador.php" class="btn btn-xs" >Ver log</a><a href="#" class="btn btn-primary btn-xs">Ativar</a></span>
                                </div>
                                <div class="list-group-item">
                                    <span style="min-width: 160px; display: inline-block;">0002</span> 
                                    <span style="min-width: 160px; display: inline-block;">Tomás Prodêncio</span>
                                    <span style="min-width: 160px; display: inline-block;">Mecanico</span>
                                    <span style="min-width: 160px; display: inline-block;">123456789</span>
                                    <span style="min-width: 160px; display: inline-block;"><a href="alterar_utilizador.php" class="btn btn-xs" >Ver / Alterar</a><a href="ver_log_utilizador.php" class="btn btn-xs" >Ver log</a><a href="#" class="btn btn-primary btn-xs">Ativar</a></span>
                                </div>
