                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                                ...
                                <div class="list-group-item">
                                    ...
                                    <span style="min-width: 80px; display: inline-block;"><a href="alterar_utente.html" class="btn btn-xs" >Ver / Alterar</a><a href="#" class="btn btn-primary btn-xs">Ativar</a></span>
                                </div>
                                <div class="list-group-item">
                                    <span style="min-width: 40px; display: inline-block;">0001</span> 
                                    <span style="min-width: 100px; display: inline-block;">João Manuel</span>
                                    ...
                                    <span style="min-width: 120px; display: inline-block;">01-01-0001</span>
                                    <span style="min-width: 110px; display: inline-block;">01-01-0001</span>
                                    <span style="min-width: 80px; display: inline-block;"><a href="alterar_utente.html" class="btn btn-xs" >Ver / Alterar</a><a href="#" class="btn btn-danger btn-xs">Desativar</a></span>
                                </div>
                                <div class="list-group-item">
                                    <span style="min-width: 40px; display: inline-block;">0001</span> 
                                    <span style="min-width: 100px; display: inline-block;">João Manuel</span>
