...
<div class="conteudo">
		...
		<ol class="breadcrumb" style="width: 800px">
				...
				<li><a href="./gerir_viaturas.html">Gerir Viaturas</a></li>
			...
			<div class="centered">
      		...
      		<a href="./gerir_viaturas.html" class="btn btn-danger btn-xl pull-right" > Voltar </a>
			<a class="btn btn-primary btn-xl pull-right"  href="./gerir_viaturas.html"> Adicionar </a><br/>
	</div>
